...
from app.routers import activity, admin_analytics, applications, assistant, auth, dashboards, fees, notifications, officer, risks, system, workflow
...
app.include_router(workflow.applicant_router, prefix="/api")
app.include_router(workflow.approval_router, prefix="/api")
