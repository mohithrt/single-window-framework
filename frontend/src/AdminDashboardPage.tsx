...
export default function AdminDashboardPage() {
  ...
  return <div className="admin-shell">
    <header className="admin-topbar"><a className="brand" href="/admin"><span className="brand-mark">M</span><span>MAHA<span className="brand-accent">CLEAR</span><span className="brand-ai">.AI</span></span></a><span className="admin-authority-chip">APEX AUTHORITY · DEMO ANALYTICS</span><nav><a href="/notifications">Notifications</a><button className="signout-button" onClick={() => void signOut()}>Sign out ↗</button></nav></header>
    <aside className="admin-sidebar"><span className="workspace-nav-label">GOVERNMENT WORKSPACE</span><a href="#overview">Overview</a><a href="#analytics">Analytics</a><a href="#departments">Departments</a><a href="#applications">Applications</a><a href="#audit">Audit log</a><a href="#integrations">Integrations</a><div><strong>North-Star</strong><small>SIH 2026 · Apex Authority</small></div></aside>
